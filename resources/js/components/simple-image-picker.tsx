        ...
        <div>
            ...
            >
                ...
                <div className="relative h-[100px] w-[100px] overflow-hidden rounded border bg-white">
                    ...
                    ></div>
                    <div
                        className={`${uploading ? 'absolute' : 'hidden'} top-0 right-0 bottom-0 left-0 z-20 flex flex-col items-center justify-center bg-black/10 backdrop-blur-[2px] transition-all duration-500`}
                    >
                ...
                <div className="">
                    <div className="flex flex-col gap-2">
                        ...
                        <label
                            id={`image-upload-${id}`}
                            className="focus:ring-primary-600 inline-flex w-max rounded-sm border border-zinc-400 bg-white px-4 py-2 text-[13px] font-semibold whitespace-nowrap text-gray-700 shadow-sm hover:bg-gray-50 focus:ring-2 focus:ring-offset-2 focus:outline-none"
                        >
                            <input
                                {...props}
                                type="file"
